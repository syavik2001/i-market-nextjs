...
export const ProductModal: React.FC<Props> = ({ className }) => {
	...
	return (
		<Dialog open={isOpen} onOpenChange={closeModal}>
			<DialogContent
				className={cn(
					"p-0 w-full max-w-[99vw] 480:max-w-[98vw] 639:max-w-[95vw] sm:max-w-[90vw] md:max-w-[80vw] 1100:max-w-[1060px] 1100:w-[1060px] 1100:min-h-[500px] bg-white overflow-hidden max-639:max-w-[340px]",
					className,
				)}
