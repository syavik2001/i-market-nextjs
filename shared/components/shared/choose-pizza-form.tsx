						...
						<div className="flex gap-2 sm:gap-3 flex-wrap 1100:grid 1100:grid-cols-3 1100:gap-3">
							{ingredients.map((ingredient) => (
								<IngredientItem
									...
									className="w-16 h-20 text-[8px] md:w-28 md:h-32 md:text-xs 1100:w-32 1100:h-36 1100:text-sm"
									imageClassName="w-9 h-9 md:w-20 md:h-20 1100:w-20 1100:h-20 object-contain mx-auto"
								/>
							))}
						</div>
					</div>
